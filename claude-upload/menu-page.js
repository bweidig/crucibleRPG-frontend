...
const PALETTES = {
  "Sword & Soil":     { accent: "#d4a94e", light: "#ffe8a0", dim: "#a08040", gradient: "linear-gradient(135deg, rgba(212,169,78,0.12) 0%, rgba(180,120,40,0.04) 100%)", iconBg: "linear-gradient(135deg, rgba(212,169,78,0.18), rgba(180,120,40,0.08))", border: "rgba(212,169,78,0.3)", glow: "rgba(212,169,78,0.08)" },
  "Smoke & Steel":    { accent: "#7cb8d4", light: "#b0ddef", dim: "#5a90a8", gradient: "linear-gradient(135deg, rgba(124,184,212,0.12) 0%, rgba(80,140,170,0.04) 100%)", iconBg: "linear-gradient(135deg, rgba(124,184,212,0.2), rgba(80,140,170,0.08))", border: "rgba(124,184,212,0.3)", glow: "rgba(124,184,212,0.08)" },
  "Concrete & Code":  { accent: "#50d4b8", light: "#8af0da", dim: "#38a890", gradient: "linear-gradient(135deg, rgba(80,212,184,0.12) 0%, rgba(40,160,140,0.04) 100%)", iconBg: "linear-gradient(135deg, rgba(80,212,184,0.2), rgba(40,160,140,0.08))", border: "rgba(80,212,184,0.3)", glow: "rgba(80,212,184,0.08)" },
  "Stars & Circuits": { accent: "#b48ee8", light: "#d4b4ff", dim: "#9068c0", gradient: "linear-gradient(135deg, rgba(180,142,232,0.12) 0%, rgba(130,90,190,0.04) 100%)", iconBg: "linear-gradient(135deg, rgba(180,142,232,0.2), rgba(130,90,190,0.08))", border: "rgba(180,142,232,0.3)", glow: "rgba(180,142,232,0.08)" },
  "Ash & Remnants":   { accent: "#e8844a", light: "#ffb888", dim: "#c06830", gradient: "linear-gradient(135deg, rgba(232,132,74,0.12) 0%, rgba(190,90,40,0.04) 100%)", iconBg: "linear-gradient(135deg, rgba(232,132,74,0.2), rgba(190,90,40,0.08))", border: "rgba(232,132,74,0.3)", glow: "rgba(232,132,74,0.08)" },
  "Dream & Myth":     { accent: "#d888c0", light: "#f0b8e0", dim: "#b068a0", gradient: "linear-gradient(135deg, rgba(216,136,192,0.12) 0%, rgba(170,90,150,0.04) 100%)", iconBg: "linear-gradient(135deg, rgba(216,136,192,0.2), rgba(170,90,150,0.08))", border: "rgba(216,136,192,0.3)", glow: "rgba(216,136,192,0.08)" },
};
const DEFAULT_PAL = { accent: "#7082a4", light: "#a0b0cc", dim: "#566a84", gradient: "linear-gradient(135deg, rgba(112,130,164,0.08) 0%, rgba(60,80,120,0.03) 100%)", iconBg: "linear-gradient(135deg, rgba(112,130,164,0.15), rgba(60,80,120,0.06))", border: "rgba(112,130,164,0.2)", glow: "rgba(112,130,164,0.06)" };
function getPal(setting) { return PALETTES[setting] || DEFAULT_PAL; }
...
function SettingIcon({ setting, color, size = 16 }) {
  ...
  switch (setting) {
    case 'Sword & Soil':
      return <svg {...props}><line x1="4" y1="20" x2="20" y2="4" /><line x1="20" y1="20" x2="4" y2="4" /><line x1="6" y1="10" x2="10" y2="6" /><line x1="14" y1="18" x2="18" y2="14" /></svg>;
    case 'Smoke & Steel':
      return <svg {...props}><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="2" /><line x1="12" y1="2" x2="12" y2="6" /><line x1="12" y1="18" x2="12" y2="22" /><line x1="2" y1="12" x2="6" y2="12" /><line x1="18" y1="12" x2="22" y2="12" /></svg>;
    case 'Concrete & Code':
      return <svg {...props}><rect x="3" y="10" width="5" height="12" rx="1" /><rect x="10" y="4" width="5" height="18" rx="1" /><rect x="17" y="8" width="5" height="14" rx="1" /></svg>;
    case 'Stars & Circuits':
      return <svg {...props}><polygon points="12,2 15,9 22,9 16.5,14 18.5,21 12,17 5.5,21 7.5,14 2,9 9,9" /></svg>;
    case 'Ash & Remnants':
      return <svg {...props}><path d="M12 22c-4 0-7-3-7-7 0-5 7-13 7-13s7 8 7 13c0 4-3 7-7 7z" /></svg>;
    case 'Dream & Myth':
      return <svg {...props}><polygon points="12,2 15,9 22,9 16.5,14 18.5,21 12,17 5.5,21 7.5,14 2,9 9,9" /><circle cx="20" cy="5" r="1" /><circle cx="4" cy="18" r="0.8" /><circle cx="21" cy="17" r="0.6" /></svg>;
    default:
...
function DiffBadge({ difficulty }) {
  ...
  const d = DIFF_COLORS[difficulty.toLowerCase()] || DIFF_COLORS.standard;
  return (
    <span style={{
      fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 10, fontWeight: 500,
...
function MetaPill({ children }) {
  return (
    <span style={{
      fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 12, color: '#8a90a4',
...
function HeroCard({ game, onClick, onDelete }) {
  const pal = getPal(game.setting);
  const isSetup = !game.character?.name || game.status === 'initializing';

  return (
    <div className={styles.heroCard} onClick={onClick} style={{
      background: 'linear-gradient(135deg, #12162a 0%, #161c32 50%, #111528 100%)',
      borderRadius: 14, borderTop: `1px solid ${pal.border}`, borderRight: `1px solid ${pal.border}`,
      borderBottom: `1px solid ${pal.border}`, borderLeft: `3px solid ${pal.accent}`,
      position: 'relative', overflow: 'hidden', padding: '28px 36px',
    }}>
      {/* Atmospheric glows */}
      <div style={{
        position: 'absolute', top: -100, right: -100, width: 380, height: 380, borderRadius: '50%',
        background: `radial-gradient(circle, ${pal.glow.replace('0.08', '0.25')} 0%, ${pal.glow} 40%, transparent 65%)`,
        pointerEvents: 'none', opacity: 0.8, transition: 'opacity 0.3s',
      }} />
      <div style={{
        position: 'absolute', bottom: -70, left: -50, width: 260, height: 260, borderRadius: '50%',
        background: `radial-gradient(circle, ${pal.glow.replace('0.08', '0.15')} 0%, transparent 65%)`,
        pointerEvents: 'none',
      }} />

      {/* Timestamp + delete */}
      <div style={{ position: 'absolute', top: 16, right: 18, display: 'flex', alignItems: 'center', gap: 10, zIndex: 2 }}>
        <span style={{ fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 11, color: '#7082a4' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{
          fontFamily: "var(--font-cinzel), serif", fontSize: 'clamp(18px, 2.5vw, 22px)', fontWeight: 700,
          color: pal.accent, letterSpacing: '0.06em', marginBottom: 14,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
          <div style={{
            ...
            background: pal.iconBg, border: `1px solid ${pal.border}`,
            display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
          }}>
            <SettingIcon setting={game.setting} color={pal.accent} size={16} />
          </div>
          <div>
            <div style={{ fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 16, fontWeight: 500, color: '#c8c0b0' }}>
              {game.character?.name || 'New Character'}
            </div>
            <div style={{ fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 12, color: pal.dim }}>
        ...
        {game.blurb && (
          <p style={{
            ...
            color: '#a0a4b4', lineHeight: 1.65, maxWidth: 560, marginBottom: 14, marginTop: 0,
          }}>{game.blurb}</p>
        )}

        {/* Resume button + meta pills */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          <button className={styles.resumeBtn} onClick={e => { e.stopPropagation(); onClick(); }}
            style={{
              background: `linear-gradient(135deg, ${pal.accent}, ${pal.light})`,
              fontFamily: "var(--font-cinzel), serif", fontSize: 13, fontWeight: 700,
              color: '#0a0e1a', padding: '11px 32px', borderRadius: 8,
              border: 'none', letterSpacing: '0.08em',
            }}>RESUME</button>
          {game.storyteller && game.storyteller !== 'pending' && (
            <MetaPill>{game.storyteller}</MetaPill>
          )}
          {game.turnCount > 0 && <MetaPill>{game.turnCount} turns</MetaPill>}
...
function GameTile({ game, onClick }) {
  ...
  return (
    <div className={styles.gameCard} onClick={onClick} style={{
      background: '#131830', borderRadius: 10, overflow: 'hidden',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div style={{ minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <span style={{
              fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 15, fontWeight: 600,
              color: '#c8c0b0', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
              transition: 'color 0.25s',
            }}>{game.character?.name || 'New Character'}</span>
            {isSetup && (
              <span style={{
                fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 8, color: '#7082a4',
                background: 'rgba(112,130,164,0.12)', padding: '1px 5px', borderRadius: 3,
              }}>SETUP</span>
            )}
          </div>
          <div style={{ fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 11, color: pal.dim }}>
      ...
      {game.blurb ? (
        <div style={{
          fontFamily: "var(--font-alegreya), serif", fontSize: 13, fontStyle: 'italic',
      ...
      <div style={{
        ...
        {(game.turnCount > 0) && (
          <span style={{
            fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 10, color: pal.accent,
            background: pal.glow, padding: '2px 7px', borderRadius: 4,
          }}>{game.turnCount} turns</span>
        )}
        <DiffBadge difficulty={game.difficulty} />
        <span style={{
          fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 10, color: '#5a6a88',
          marginLeft: 'auto',
...
function GameDetailModal({ game, onClose, onResume, onDelete }) {
  const pal = getPal(game.setting);
  const isSetup = !game.character?.name || game.status === 'initializing';
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={onClose}>
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        background: '#111528', borderTop: `1px solid ${pal.border}`, borderRight: `1px solid ${pal.border}`,
        borderBottom: `1px solid ${pal.border}`, borderLeft: `4px solid ${pal.accent}`,
        borderRadius: 12, padding: '32px 36px 28px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
          <div style={{
            ...
            <SettingIcon setting={game.setting} color={pal.accent} size={18} />
          </div>
          <div>
            <div style={{ fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 22, fontWeight: 600, color: '#e0d8c8' }}>
              {game.character?.name || 'New Character'}
            </div>
            <div style={{ fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 13, color: pal.dim }}>
              {game.setting !== 'pending' ? game.setting : 'New World'}
            </div>
          </div>
        </div>
        ...
        {game.blurb && (
          <p style={{
            fontFamily: "var(--font-alegreya), serif", fontSize: 14, fontStyle: 'italic',
            color: '#a0a4b4', lineHeight: 1.7, margin: '0 0 16px',
          }}>{game.blurb}</p>
        )}

        {/* Meta pills */}
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 16 }}>
          {game.storyteller && game.storyteller !== 'pending' && <MetaPill>{game.storyteller}</MetaPill>}
          <DiffBadge difficulty={game.difficulty} />
          {game.turnCount > 0 && <MetaPill>{game.turnCount} turns</MetaPill>}
        </div>
        ...
        {/* Status */}
        <div style={{
          fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 12, color: '#5a6a88',
          textTransform: 'capitalize', marginBottom: 20,
        }}>{isSetup ? 'In Setup' : game.status}</div>

        {/* Actions */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <button className={styles.resumeBtn} onClick={onResume} style={{
            background: `linear-gradient(135deg, ${pal.accent}, ${pal.light})`,
            fontFamily: "var(--font-cinzel), serif", fontSize: 13, fontWeight: 700,
            color: '#0a0e1a', padding: '11px 32px', borderRadius: 8,
            border: 'none', letterSpacing: '0.08em',
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center" }} onClick={onClose}>
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <h2 style={{ fontFamily: "var(--font-cinzel), serif", fontSize: sz.heading - 8, color: "#d0c098", marginBottom: 20, marginTop: 0 }}>
          Display Settings
        </h2>
        ...
        <button onClick={onClose} style={{ position: "absolute", top: 12, right: 14,
          background: "none", border: "none", color: "#6b83a3", fontSize: 16, cursor: "pointer" }}>{'\u2715'}</button>
      </div>
    </div>
  );
}
        ...
        {snapshots === null ? (
          ...
          <div style={{ textAlign: 'center', padding: '10px 0' }}>
            ...
            <button onClick={onClose} style={{
              ...
              color: "#c9a84c", background: 'none', border: "1px solid #3a3328",
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {snapshots.map(snap => {
                const sPal = getPal(snap.setting || snap.settingName);
                return (
                  <div key={snap.id} onClick={() => !creating && handleSelect(snap)} className={styles.gameCard} style={{
                    background: '#0d1120', borderLeft: `3px solid ${sPal.accent}`,
                    ...
                    <div style={{ fontFamily: "var(--font-cinzel), serif", fontSize: 11, fontWeight: 600, color: sPal.accent, letterSpacing: '0.1em', marginBottom: 6 }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 10, color: "#9a8545" }}>
                        {snap.type === 'fresh_start' ? 'Fresh Start' : 'Branch'}
                      </span>
                      <span style={{ fontFamily: "var(--font-alegreya-sans)", fontSize: 12, color: "#7082a4" }}>
...
export default function MenuPage() {
  ...
  useEffect(() => {
    try {
      const saved = JSON.parse(localStorage.getItem('crucible_display_settings') || '{}');
      if (saved.font) setFont(saved.font);
      if (saved.textSize) setTextSize(saved.textSize);
    } catch { /* ignore */ }
  }, []);
  useEffect(() => {
    try { localStorage.setItem('crucible_display_settings', JSON.stringify({ font, textSize })); } catch { /* ignore */ }
  }, [font, textSize]);
    ...
    <div className={styles.pageContainer} style={{ minHeight: "100vh", background: "#0a0e1a", color: "#c8c0b0", position: "relative" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 4, userSelect: "none" }}>
              <span style={{ fontFamily: "var(--font-cinzel), serif", fontSize: 22, fontWeight: 900, color: "#c9a84c", letterSpacing: "0.06em" }}>CRUCIBLE</span>
              <span style={{ fontFamily: "var(--font-cinzel), serif", fontSize: 12, fontWeight: 600, color: "#9a8545", letterSpacing: "0.08em" }}>RPG</span>
            </div>
            <div style={{
              fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 10, color: "#7082a4",
              border: "1px solid #3a3328", borderRadius: 4, padding: "2px 7px",
            }}>EARLY ACCESS</div>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <Link href="/rulebook" className={styles.navLink} style={{
              fontFamily: "var(--font-cinzel), serif", fontSize: 11, fontWeight: 600,
              color: "#9a8545", letterSpacing: "0.1em",
            }}>RULEBOOK</Link>
            <AuthAvatar size={32} />
          </div>
        </div>
        ...
        {error && (
          <div style={{
            ...
            fontFamily: "var(--font-alegreya-sans), sans-serif", fontSize: 14, color: '#e8845a',
          }}>{error}</div>
        )}
        ...
        {!isPlaytester && (
          <div style={{
            background: "#111528", border: "1px solid #3a3328", borderRadius: 12,
            ...
            <p style={{ fontFamily: "var(--font-alegreya), serif", fontSize: 18, fontStyle: "italic", color: "#8a94a8", lineHeight: 1.7, maxWidth: 480, margin: "0 auto 20px" }}>
              Your account is pending playtester access.
            </p>
          ...
          <div style={{ position: 'relative' }}>
            ...
            {hasGames ? (
              <>
                {/* Welcome text */}
                <div style={{
                  fontFamily: "var(--font-cinzel), serif", fontSize: 'clamp(32px, 5vw, 42px)', fontWeight: 700,
                ...
                <div style={{
                  fontFamily: "var(--font-alegreya), serif", fontSize: 16, fontStyle: 'italic', fontWeight: 400,
                ...
                <div style={{
                  ...
                  <HeroCard game={activeGame} onClick={() => navigateToGame(activeGame)} onDelete={setDeleteTarget} />
                </div>
                ...
                <div style={{
                  ...
                  <button className={styles.newGameBtn} onClick={() => router.push('/init')} style={{
                    ...
                    fontFamily: "var(--font-cinzel), serif", fontSize: 14, fontWeight: 700, letterSpacing: '0.08em',
                  ...
                  {isPlaytester && (
                    <button className={styles.templateBtn} onClick={() => setShowSnapshots(true)} style={{
                      ...
                      fontFamily: "var(--font-cinzel), serif", fontSize: 12, fontWeight: 600, letterSpacing: '0.06em',
              ...
              <div style={{ textAlign: 'center', padding: '60px 0 48px' }}>
                ...
                <button className={styles.newGameBtn} onClick={() => router.push('/init')} style={{
                  ...
                  fontFamily: "var(--font-cinzel), serif", fontSize: 15, fontWeight: 700, letterSpacing: '0.1em',
                  background: 'linear-gradient(135deg, #c9a84c, #ddb84e)', border: 'none', color: '#0a0e1a',
                  boxShadow: '0 2px 16px rgba(201,168,76,0.2)',
      ...
      {isPlaytester && hasGames && otherGames.length > 0 && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 16 }}>
            <span style={{ fontFamily: "var(--font-cinzel), serif", fontSize: 13, fontWeight: 600, color: '#c9a84c', letterSpacing: '0.15em' }}>YOUR GAMES</span>
            <span style={{ fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 11, color: '#5a6a88' }}>({otherGames.length})</span>
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: 11, color: "#a08a48" }}>
            Crucible RPG {'\u00B7'} Early Access {'\u00B7'} v0.1.0
          </div>
          <div style={{ fontFamily: "var(--font-alegreya), serif", fontSize: 12, color: "#a08a48", fontStyle: "italic" }}>
      ...
      {detailTarget && (
        <GameDetailModal
          ...
          onResume={() => { setDetailTarget(null); navigateToGame(detailTarget); }}
