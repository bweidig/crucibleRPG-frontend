...
// --- SECTION DATA ---
// Content from rulebook-copy-v2.md
...
const SECTIONS = [
  ...
  },
  {
    ...
    content: `<p>This section applies only to characters with POT. Mundane characters can skip it entirely.</p><h3>How Supernatural Actions Work</h3><p>Same resolution system as everything else: POT + skill + equipment quality + die roll vs DC. The setting determines what "supernatural" means: magic in fantasy, psionics in sci-fi, divine gifts in religious settings. The mechanics are the same regardless.</p><p>Your magical domain (defined by your skills) determines which elements your offensive spells can produce. A character with Fire Magic produces fire effects. A character with a broad skill like Elemental Magic has wider options.</p><h3>Spell Output Types</h3><ul><li><strong>Damage</strong> - Inflicts CON severity + elemental rider. Armor applies (except on crits).</li><li><strong>Control</strong> - Imposes conditions directly (entangle, blind, slow). Bypasses armor entirely.</li><li><strong>Hybrid</strong> - Reduced damage + reduced condition. Costs more strain. Both effects at reduced power.</li><li><strong>Healing</strong> - Reduces condition severity on a target.</li><li><strong>Enhancement</strong> - Temporarily grants an enchantment effect: coat a weapon in fire, grant darkvision, boost an ally's strength, grant flight. One effect per cast.</li><li><strong>Transformation</strong> - Temporarily replace your mechanical identity with a creature form. Stats change, equipment suspends, you gain natural weapons and form abilities.</li><li><strong>Conjuration</strong> - Summon a group of creatures under your control. One active group at a time.</li></ul><h3>Cantrips</h3><p>The lightest supernatural actions. Three tiers:</p><ul><li><strong>Cosmetic</strong> - No roll needed. Light a candle, chill a drink, make a small sound. Purely narrative.</li><li><strong>Chip Damage</strong> - Roll required. Small damage that scales with your POT and implement.</li><li><strong>Minor Disruption</strong> - Roll required. Brief, weak condition on a single target (1 turn). Creates tactical openings without swinging fights alone.</li></ul><p>Cantrips can be used as a primary or swift action. The first 5 per rest period are free. After that, each additional cantrip inflicts minor POT strain (-0.2). This is a soft brake, not a hard stop.</p><h3>Mental Strain: The Cost of Power</h3><p>Every supernatural action drains your Potency:</p><ul><li><strong>Cantrips</strong> - Free (first 5 per rest, then -0.2 POT each)</li><li><strong>Standard spells</strong> - Immediate POT reduction (-0.5 per cast, stacking)</li><li><strong>Major spells</strong> - Larger reduction (-1.0 per cast)</li><li><strong>Legendary</strong> - POT drops to zero + Fate Check. Campaign-defining, last-resort power.</li></ul><p>When POT runs low, cascading fatigue kicks in:</p><ul><li>POT below 3.0: penalty to all supernatural action rolls</li><li>POT below 1.0: penalty to ALL actions</li></ul><p>Mental Strain cannot be healed by magic or medical care. Recovery is time-based:</p><ul><li><strong>Passive recovery</strong> - +0.5 per day (faster than the standard +0.3 for other conditions)</li><li><strong>Short Rest</strong> - Once per day, a few hours of focused meditation restores +0.5 POT</li><li><strong>Long Rest bonus</strong> - A full rest restores an additional +1.0 POT on top of passive recovery</li><li>A full rest day with no adventuring restores +1.5 POT total</li></ul><h3>Implements (Casting Focuses)</h3><p>All non-cantrip spells require either an implement in hand or a free hand. Cantrips have no hand requirement.</p><p>Implements boost casting damage through a Channel Modifier:</p><ul><li>No focus (bare hand): +0.0</li><li>Wand: +0.5 (one-handed, concealable)</li><li>Rod: +1.0 (one-handed)</li><li>Staff: +1.5 (two-handed, can double as a melee weapon)</li></ul><p>Conduit weapons let you cast through your weapon without any equipment juggling. A spellblade with a conduit longsword and shield can attack one turn and cast the next.</p><h3>Supernatural Defense</h3><p>When defending against supernatural attacks, you pick the stat that fits the fiction:</p><ul><li>DEX to dodge a fire bolt</li><li>WIS to resist a mental intrusion</li><li>CON to endure a life drain</li><li>POT to disrupt the spell directly (requires POT > 0.0)</li></ul><p>Saying "I disrupt their spell with my own power" is a valid defense using POT.</p><h3>Enhancement: Temporary Enchantment</h3><p>Enhancement spells temporarily grant a single enchantment category effect. One cast, one effect. If you want darkvision and fire resistance, that's two separate spells.</p><p>What you can grant:</p><ul><li>Stat boosts (+0.5 to +1.5 to one stat)</li><li>Element coating on a weapon (coat your sword in fire for the duration)</li><li>Tag grants (give your fists the reach property, make your weapon armor-effective)</li><li>Condition resistance (fire resistance, poison resistance)</li><li>Passive utility (darkvision, water breathing, flight)</li></ul><p>Enhancement effects stack on top of equipment enchantments on a separate layer. Recasting the same effect refreshes the duration but doesn't stack the magnitude. Each cast costs strain and requires a roll that can fail.</p><p>Flight is a Major-tier Enhancement. While active, you ignore ground hazards and difficult terrain, are immune to melee from grounded enemies without reach weapons, and have an elevated position. When flight expires in a dangerous position, the system warns you one turn early, then forces a DEX check for landing.</p><p>Enhancement effects can be dispelled by enemies (contested POT check). Equipment enchantments can only be suppressed, not stripped. This is the key difference: spell effects are more flexible but more fragile.</p><h3>Transformation: Becoming Something Else</h3><p>Transformation temporarily replaces your stats, suspends your equipment, and gives you a creature form with natural weapons and potentially special abilities. Everything reverts cleanly when the form ends.</p><p>Six archetypes:</p><ul><li><strong>Beast (Agile)</strong> - Fast, high DEX. Wolf, panther, hawk.</li><li><strong>Beast (Brute)</strong> - Strong, high STR. Bear, gorilla, boar.</li><li><strong>Beast (Scout)</strong> - Utility form. Minimal combat. Flight or swim for scouting.</li><li><strong>Elemental</strong> - Caster's combat form. Attacks carry your element. Vulnerable to the opposing element.</li><li><strong>Monstrous</strong> - Apex combat form. Highest stats, most powerful abilities. Dragon, hydra, basilisk.</li><li><strong>Hybrid</strong> - Retains all your capabilities (casting, speech, weapons) with moderate stat boosts. The "half-wolf" or "dragon-blooded" form.</li><li><strong>Swarm</strong> - Collective form (insects, rats, nanites). Can't be grappled, resistant to physical damage. Exotic problem-solving form.</li></ul><p>Two cost tiers:</p><ul><li><strong>Major</strong> (-1.0 POT) - Beast and Hybrid forms. Lasts until you dismiss it. The POT spent can't recover until you revert.</li><li><strong>Legendary</strong> (POT drops to zero) - Elemental, Monstrous, and Swarm forms. Fixed duration (6-8 turns). Fate Check triggers when you revert, not when you transform.</li></ul><p>Damage taken in form carries over proportionally when you revert. A bear's toughness absorbs most of the impact, but you'll still feel it in your original body. The system warns you when the gap between your form's health and your real body's health becomes dangerous.</p><h3>Hostile Polymorph: Being Transformed Against Your Will</h3><p>An enemy caster can attempt to transform you into a helpless creature. If they succeed, your stats are replaced with the diminished form's stats (very low), your equipment suspends, and you can't cast, speak, or fight effectively.</p><p>But you're not helpless:</p><ul><li>Each turn, you choose how to resist: Willpower (WIS), Power (POT), Endurance (CON), or Reason (INT)</li><li>Each failed attempt gives you a cumulative +1.0 bonus to the next try</li><li>You can take struggle actions after a failed attempt: Flee, Hide, Distract an enemy, or Resist (sacrifice your action for an extra +1.0 on your next break-free)</li><li>Hard cap: 8 turns maximum. The polymorph auto-ends at turn 9.</li><li>Your polymorphed form is invulnerable. No damage, no wound carryover. This is a time prison, not a death sentence.</li><li>Breaking the caster's concentration (allies hitting the caster) or counterspelling can also free you</li></ul><p>When you break free, you return at your pre-polymorph health with all equipment restored. After any reversion, you gain 5 turns of polymorph immunity.</p><h3>Conjured Groups: Summoning Allies</h3><p>You can summon a group of creatures that fights alongside you. The system tracks the group as one entity with one action per turn and a shared health pool.</p><p>Three modes at casting:</p><ul><li><strong>Single</strong> - One powerful entity. Higher tier, access to special combat techniques.</li><li><strong>Pack</strong> (2-4 entities) - Coordination bonus to attacks. Vulnerable to area damage.</li><li><strong>Horde</strong> (5-8 entities) - Larger coordination bonus. Vulnerable to area damage. Takes two turns to cast (can be interrupted).</li></ul><p>Summoned groups inherit your element domain. A fire mage's skeletons have fire-element attacks.</p><p>Sustaining a magical group locks a portion of your POT. That locked POT counts as spent for everything: other spell costs, Fate Checks, effective stat calculations. You're trading sustained magical investment for a persistent combat ally.</p><p>Physical groups (tamed animals, constructs built through crafting) require no POT. They're acquired through backstory or Extended Tasks with the right skills. Constructs are permanent and repairable. Tamed animals are permanent but their loss is genuine, not just a tactical setback.</p><p>You can have one conjured group and one companion at the same time, for a maximum of two allied entities.</p><div class="mechanic-callout">The specific abilities available depend on your setting. A dark fantasy world might offer blood magic with serious consequences. A sci-fi setting might give you cybernetic implants that strain your body. The system adapts to the genre, but the cost is always real.</div>`,
  },
  {
    id: 'survival', number: 14, title: 'Survival',
    content: `<p>Your character needs food, water, and rest. Neglecting these basics has real consequences.</p><h3>Food &amp; Water</h3><p>On Standard, Harsh, and Brutal difficulty, you consume 1 water + 1 ration daily.</p><ul><li>Miss a meal: [Malnourished: -0.5 CON] that escalates to [Starving] after 48 hours, then eventually becomes fatal</li><li>Can be toggled off entirely in difficulty settings (Forgiving, or Survival dial set to Off)</li></ul><h3>Rest &amp; Long Rest</h3><p>Long Rest requires:</p><ul><li>6+ hours of uninterrupted rest</li><li>Having eaten that day</li><li>Max one Long Rest per 24 hours</li></ul><p>Long Rest clears certain conditions, restores strain, refreshes Active Skill cooldowns and item charges. End of Day Reflection happens during Long Rest. This is when your stats and skills grow.</p><h3>Safe vs Unsafe Rest</h3><ul><li><strong>Safe locations</strong> (towns, secured camps, player property): rest completes automatically</li><li><strong>Unsafe locations</strong> (dungeons, enemy territory, wilderness): contested check. Failure means ambush during rest. No benefits gained, rations still consumed.</li><li>You'll get a qualitative signal before committing: "The area feels tense" vs "This place seems secure."</li></ul><h3>Recovery Methods</h3><ul><li><strong>Passive Recovery</strong> - +0.3 per day to conditions. Requires relative safety but no resources. Slow but free. POT recovers faster at +0.5 per day (see Section 13).</li><li><strong>Triage</strong> - Medical treatment (self or others). Divides remaining condition penalty by 5 for immediate partial reduction. Tools help. Does not work on Mental Strain (POT).</li><li><strong>Short Rest</strong> - Once per day, a few hours of focused meditation restores +0.5 POT. The caster's equivalent of triage. No effect on non-POT conditions.</li><li><strong>Time Skip</strong> - In safe locations, fast-forward rest and recovery without playing through each day.</li></ul><h3>The Abyss of Zero</h3><p>If any stat hits 0.0:</p><ul><li>Voluntary actions using that stat are forbidden</li><li>Involuntary actions (crawling, shivering, survival instinct) still work</li><li>Stats below 0.0 impose an additional penalty on all rolls using that stat</li><li>Recovery: +0.1 every 4 hours if you're in relative safety</li></ul><h3>Adrenaline Surge</h3><p>Once per day, if any stat is at 0.0 or below, you can force it to 1.0 for one single action. Afterward, that stat takes a -1.0 penalty until Long Rest. Your one desperate shot when everything has gone wrong.</p>`,
  },
  {
