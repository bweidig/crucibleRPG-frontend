...
function SocialButton({ icon, label, onClick }) {
  return (
    <button onClick={onClick} className={styles.socialButton}>
      ...
      <div style={{ display: 'flex', gap: 4, marginBottom: 5 }}>
        {[0, 1, 2, 3, 4].map(i => (
          <div key={i} style={{
            ...
            background: i <= strength ? color : 'rgba(201,168,76,0.06)',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'rgba(10, 14, 26, 0.7)', border: '1px solid rgba(201,168,76,0.08)', borderRadius: 12,
        ...
        {mode !== 'forgot' && (
          <div style={{
            display: 'flex', marginBottom: 26, background: 'rgba(10, 14, 26, 0.5)', borderRadius: 6, padding: 3,
            ...
            {[
              ...
              <button key={tab.id} onClick={() => setMode(tab.id)} style={{
                ...
                background: mode === tab.id ? 'rgba(201,168,76,0.08)' : 'transparent',
        ...
        {mode === 'signup' && (
          <>
            ...
            >
              <button onClick={() => setShowPassword(!showPassword)} className={styles.passwordToggle}>
            ...
            <div style={{
              ...
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${agreedToTerms ? 'var(--accent-gold)' : 'rgba(201,168,76,0.15)'}`,
                  background: agreedToTerms ? 'rgba(201,168,76,0.12)' : 'transparent',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        {mode === 'signin' && (
          <>
            ...
            <div style={{ textAlign: 'right', marginTop: -12, marginBottom: 20 }}>
              <button onClick={() => setMode('forgot')} className={styles.textLink} style={{
        ...
        {mode === 'forgot' && (
          <div style={{ textAlign: 'center', marginTop: 18 }}>
            <button onClick={() => setMode('signin')} className={styles.textLink} style={{ fontSize: 15 }}>
              &#8592; Back to Sign In
            </button>
          </div>
        )}
